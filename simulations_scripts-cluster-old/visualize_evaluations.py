...
trueRsqr   =[0.602,0.602,0.604,0.901,0.903,0.901]
trueMSE    =[13.53,20.16,25.64,0.89,3.47,2.04]
...
for i in range(5,6):
    print(i)
    dirName=str(i+1)+"-evaluation-cor"+str(corelations[i])+\
        "-Rsqr"+str(trueRsqr[i])[:3]+"-300"
